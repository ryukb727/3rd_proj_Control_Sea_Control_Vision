...
- **MQTT**를 사용한 **실시간 데이터 전송** 및 **경고 발송 시스템** 구현을 보조하며 알게된 새로운 통신 방식
- **STT**와 **TTS**를 활용한 **자동 항해 일지 작성 및 브리핑** 시스템을 통해 **음성 인식 및 합성**의 유용성을 실감
- 충분한 성능 확보를 위한 **실시간 시스템 최적화**의 중요함
---
...
### 2) **海上霧データセットの確保問題**  
- 原因: AI学習と性能検証のための**霧のかかった海上環境の航行データセット**が必要だったか、公開されている高品質な**データセット不在**
